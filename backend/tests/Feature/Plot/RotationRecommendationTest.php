...
class RotationRecommendationTest extends TestCase
{
    ...
    public function test_current_zone_is_rejected_when_rotation_would_keep_plant_in_place(): void
    {
        ...
        $this->assertContains('TikslinÄ— zona sutampa su dabartine augalo zona, todÄ—l tai nÄ—ra tinkama rotacija.', $blockingReasons);
        $this->assertNotContains('TikslinÄ—je zonoje jau yra to paties tipo augalÅ³ konfliktas.', $blockingReasons);
    }
    ...
    public function test_plot_wide_plan_returns_valid_target_zones_with_zone_specific_reasons(): void
    {
        ...
        $this->assertContains('TikslinÄ—je zonoje pakanka vietos Åiam augalui.', $selectedReasons);
        $this->assertSame('invalid', $candidateZones['Uzkrauta zona']['verdict']);
        $this->assertContains('TikslinÄ—je zonoje nepakanka vietos Åiam augalui.', $candidateZones['Uzkrauta zona']['blocking_reasons']);
    }
    ...
    public function test_score_and_reasons_match_target_zone_validation_result(): void
    {
        ...
        $this->assertContains('TikslinÄ—je zonoje nepakanka vietos Åiam augalui.', $candidates['Per maza']['blocking_reasons']);
    }
